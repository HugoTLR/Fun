...
import time
import cv2 as cv
#from solver import process_screen,setupInfo,get_contour_precedence,get_digits_cnts
import glob
import os, os.path
import keyboard
import argparse
...
class Model:
  ...
  def initiateModel(self):
    ...
    self.model.add(tf.keras.layers.Flatten(input_shape=(32,32,1)))#))  #Input layer
